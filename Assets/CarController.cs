...
public class CarController : MonoBehaviour
{
    ...
    public static float bestLap = 0f;
    ...
    private void OnCollisionEnter(Collision collision)
    {
        if (collision.gameObject.name == "Finish")
        {
            ...
            if (timeSinceStart <= bestLap || bestLap == 0 ) 
            { 
                bestLap = timeSinceStart;
            }
            Death();
        }
        else 
    ...
    public static float getBestTimeCounter()
    {
        return bestLap;
    }

    public static int getFinishCounter()
    {
    ...
    private void CalculateFitness() 
    {
        ...
        if (timeSinceStart > 9999 && overallFitness < 40)
        {
            Death();
        }
